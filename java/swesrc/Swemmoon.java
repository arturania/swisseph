 ...
 */
...
#ifdef TRACE0
    Trace.level++;
    Trace.log("Swemmoon(SwissData, SwissLib)");
#ifdef TRACE1
    Trace.log("   swed: " + swed + "\n    sl: " + sl);
#endif /* TRACE1 */
#endif /* TRACE0 */
  ...
  -8.552017636339e+001, /* t^2 SMath.cos(18V - 16E - l) */
  -2.055794304596e+002, /* t^2 SMath.sin(18V - 16E - l) */
  -1.097555241866e+000, /* t^3 SMath.cos(18V - 16E - l) */
   5.219423171002e-001, /* t^3 SMath.sin(18V - 16E - l) */
   2.088802640755e-003, /* t^4 SMath.cos(18V - 16E - l) */
   4.616541527921e-003, /* t^4 SMath.sin(18V - 16E - l) */
   4.794930645807e+000, /* t^2 SMath.cos(10V - 3E - l) */
  -4.595134364283e+001, /* t^2 SMath.sin(10V - 3E - l) */
  -6.659812174691e-002, /* t^3 SMath.cos(10V - 3E - l) */
  -2.570048828246e-001, /* t^3 SMath.sin(10V - 3E - l) */
   6.229863046223e-004, /* t^4 SMath.cos(10V - 3E - l) */
   5.504368344700e-003, /* t^4 SMath.sin(10V - 3E - l) */
  -3.084830597278e+000, /* t^2 SMath.cos(8V - 13E) */
  -1.000471012253e+001, /* t^2 SMath.sin(8V - 13E) */
   6.590112074510e-002, /* t^3 SMath.cos(8V - 13E) */
  -3.212573348278e-003, /* t^3 SMath.sin(8V - 13E) */
   5.409038312567e-004, /* t^4 SMath.cos(8V - 13E) */
   1.293377988163e-003, /* t^4 SMath.sin(8V - 13E) */
   2.311794636111e+001, /* t^2 SMath.cos(4E - 8M + 3J) */
  -3.157036220040e+000, /* t^2 SMath.sin(4E - 8M + 3J) */
  -3.019293162417e+000, /* t^2 SMath.cos(18V - 16E) */
  -9.211526858975e+000, /* t^2 SMath.sin(18V - 16E) */
  -4.993704215784e-002, /* t^3 SMath.cos(18V - 16E) */
   2.991187525454e-002, /* t^3 SMath.sin(18V - 16E) */
  -3.827414182969e+000, /* t^2 SMath.cos(18V - 16E - 2l) */
  -9.891527703219e+000, /* t^2 SMath.sin(18V - 16E - 2l) */
  -5.322093802878e-002, /* t^3 SMath.cos(18V - 16E - 2l) */
   3.164702647371e-002, /* t^3 SMath.sin(18V - 16E - 2l) */
   7.713905234217e+000, /* t^2 SMath.cos(2J - 5S) */
  -6.077986950734e+000, /* t^3 SMath.sin(2J - 5S) */
  -1.278232501462e-001, /* t^2 SMath.cos(L - F) */
   4.760967236383e-001, /* t^2 SMath.sin(L - F) */
  -6.759005756460e-001, /* t^3 SMath.sin(l') */
   1.655727996357e-003, /* t^4 SMath.sin(l') */
   1.646526117252e-001, /* t^3 SMath.sin(2D - l') */
  -4.167078100233e-004, /* t^4 SMath.sin(2D - l') */
   2.067529538504e-001, /* t^3 SMath.sin(2D - l' - l) */
  -5.219127398748e-004, /* t^4 SMath.sin(2D - l' - l) */
  -1.526335222289e-001, /* t^3 SMath.sin(l' - l) */
  -1.120545131358e-001, /* t^3 SMath.sin(l' + l) */
   4.619472391553e-002, /* t^3 SMath.sin(2D - 2l') */
   4.863621236157e-004, /* t^4 SMath.sin(2D - 2l') */
  -4.280059182608e-002, /* t^3 SMath.sin(2l') */
  -4.328378207833e-004, /* t^4 SMath.sin(2l') */
  -8.371028286974e-003, /* t^3 SMath.sin(2D - l) */
   4.089447328174e-002, /* t^3 SMath.sin(2D - 2l' - l) */
  -1.238363006354e-002, /* t^3 SMath.sin(2D + 2l' - l) */
  };
#else
  /* The following coefficients were calculated by a simultaneous least
...
#ifdef TRACE0
    Trace.log("Swemmoon.swi_moshmoon2(double, double[])");
#endif /* TRACE0 */
    int i;
  ...
  int swi_moshmoon(double tjd, boolean do_save, double[] xpmret,
                   StringBuffer serr) {
#ifdef TRACE0
    Trace.log("Swemmoon.swi_moshmoon(double, boolean, double[], StringBuffer)");
#endif /* TRACE0 */
    int i;
...
#ifdef TRACE0
    Trace.log("Swemmoon.swi_mean_node(double, double[], StringBuffer)");
#endif /* TRACE0 */
    return swi_mean_node(J, pol, 0, serr);
  }
  int swi_mean_node(double J, double pol[], int offs, StringBuffer serr) {
#ifdef TRACE0
    Trace.log("Swemmoon.swi_mean_node(double, double[], int, StringBuffer)");
#endif /* TRACE0 */
#if 0
//  double a, b, c;
#endif /* 0 */
...
#ifdef TRACE0
    Trace.log("Swemmoon.swi_mean_apog(double, double[], StringBuffer)");
#endif /* TRACE0 */
    return swi_mean_apog(J, pol, 0, serr);
  }
  int swi_mean_apog(double J, double pol[], int offs, StringBuffer serr) {
#ifdef TRACE0
    Trace.log("Swemmoon.swi_mean_apog(double, double[], int, StringBuffer)");
#endif /* TRACE0 */
#if 0
//    int i;
//    double a, b;
...
//    pol[0] = sl.swi_mod2PI(pol[0] * SwissData.DEGTORAD + SMath.PI);
//    b = pol[0];
...
//                                                            /* 2nd focus */
    ...
    pol[3] = swi_mod2PI((SWELP - MP) * SwephData.STR + SMath.PI);
    pol[4] = 0;
...
#ifdef TRACE0
    Trace.log("Swemmoon.chewm(short[], int, int, int, double[])");
#endif /* TRACE0 */
    int npt=0;
    int i, j, k, k1, m;
...
#ifdef TRACE0
    Trace.log("Swemmoon.sscc(int, double, int)");
#endif /* TRACE0 */
...
#ifdef TRACE0
    Trace.log("Swemmoon.ecldat_equ2000(double, double[])");
#endif /* TRACE0 */
    /* cartesian */
...
#ifdef TRACE0
    Trace.log("Swemmoon.mods3600(double)");
#endif /* TRACE0 */
    double lx;
    lx = x;
...
#ifdef TRACE0
    Trace.log("Swemmoon.swi_mean_lunar_elements(double, DblObj, DblObj, DblObj, DblObj)");
#endif /* TRACE0 */
  ...
  void mean_elements() {
#ifdef TRACE0
    Trace.log("Swemmoon.mean_elements()");
#endif /* TRACE0 */
    double fracT = T%1.;
